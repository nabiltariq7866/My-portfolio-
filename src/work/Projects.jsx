      ...
      <div className="md:pl-3 ">
        ...
        >
          ...
          <div className="flex items-center justify-between md:justify-end w-full relative">
            ...
            />
            <div className="w-[50px] h-[50px] md:min-w-24 md:min-h-24 hover:bg-[#80DB66] hover:border-[#80DB66] cursor-pointer rounded-full border border-[#bcc7d3] text-[#80DB66] font-semibold font-jost text-2xl flex items-center justify-center hover:text-white transition duration-500" onClick={()=>setModal(true)}>
              +
            </div>
          </div>
        </div>

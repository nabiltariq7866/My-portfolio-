...
const Projects = ({isFirst=false}) => {
  return (
    <div className="md:pl-3 ">
        {/* this div when i hover image will apear */}
      <div className={`pt-12 pb-[38px] px-3 md:px-0 relative ${isFirst ? "border-t border-b":"border-b"} flex md:items-center flex-col md:flex-row group border-[#c8ccd4]`}>
        ...
        <div className="flex items-center justify-between md:justify-end w-full relative">
          <img src={img} alt="" className="relative basis-[50%] md:basis-0 z-20  md:absolute md:mb-[10px] md:group-hover:opacity-100 group-hover:-rotate-12 left-0 md:opacity-0 w-[193px] md:w-[280px] transition-all duration-700" />

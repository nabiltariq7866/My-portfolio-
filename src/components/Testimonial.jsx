...
const Testimonial = () => {
  return (
    <div className="lg:max-w-[1350px] py-40 relative testimonals  md:px-4 flex flex-wrap mx-auto">
      ...
      <div className="flex-shrink-0 px-2 flex-grow-0 relative max-w-full basis-full lg:basis-2/5 lg:max-w-[40%]  lg:absolute lg:right-[-6%] z-10">
